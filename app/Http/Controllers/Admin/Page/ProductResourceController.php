...
class ProductResourceController extends BaseController
{
                                ...
                                PageCategoryRepositoryInterface $category)
    {
        ...
        $this->category_slug = 'product';
        $this->main_url = 'page/product';
    ...
    public function show(PageRequest $request,Page $product)
    {
        return parent::show($request,$product);
    }
    public function update(PageRequest $request,Page $product)
    {
        return parent::update($request,$product);
    }
    public function destroy(PageRequest $request,Page $product)
    {
        return parent::destroy($request,$product);
    }
