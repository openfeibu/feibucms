        ...
        <div class="layui-col-md12">
            <div class="tabel-message">
                <div class="layui-inline tabel-btn">
                    <button class="layui-btn layui-btn-warm "><a href="<?php echo e(guard_url('business/create')); ?>">添加新闻动态</a></button>
...
<script>
    ...
    var delete_all_url = "<?php echo e(guard_url('news/deleteAll')); ?>";
