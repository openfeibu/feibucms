            ...
            <div class="fb-main-table">
                <form class="layui-form" action="{{guard_url('permission')}}" method="post" lay-filter="fb-form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="checkbox" name="subs[create]" title="{{ trans('app.create') }}" value="{{ trans('app.create') }}">
                            <input type="checkbox" name="subs[store]" title="{{ trans('app.store') }}" value="{{ trans('app.store') }}">
                            <input type="checkbox" name="subs[show]" title="{{ trans('app.edit') }}" value="{{ trans('app.edit') }}">
                            <input type="checkbox" name="subs[update]" title="{{ trans('app.update') }}" value="{{ trans('app.update') }}">
